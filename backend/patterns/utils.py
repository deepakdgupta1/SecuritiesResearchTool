...
def find_local_extrema(data: pd.Series, order: int = 5) -> Tuple[List[int], List[int]]:
    """
...
def is_volume_drying_up(volume: pd.Series, window: int = 20, threshold_ratio: float = 0.8) -> bool:
    """
