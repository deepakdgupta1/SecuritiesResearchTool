...
class TestSymbol:
    ...
    def test_create_symbol(self, db_session, unique_symbol):
        ...
        retrieved = db_session.query(Symbol).filter_by(
            symbol=unique_symbol).first()
...
class TestPriceData:
    ...
    def test_price_data_relationship(self, db_session, unique_symbol):
        ...
        # Test relationship
        symbol_with_prices = db_session.query(
            Symbol).filter_by(symbol=unique_symbol).first()
...
class TestPatternDetection:
    ...
    def test_pattern_detection_metadata_jsonb(self, db_session, unique_symbol):
        ...
        retrieved = db_session.query(PatternDetection).filter_by(
            symbol_id=symbol.id).first()
...
class TestBacktestTrade:
    ...
    def test_backtest_trade_relationships(self, db_session, unique_symbol):
        ...
        # Test relationship
        retrieved_backtest = db_session.query(
            BacktestResult).filter_by(id=backtest.id).first()
